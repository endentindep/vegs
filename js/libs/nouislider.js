...
(function () {
	const leftInput = document.querySelector('.price-filter__from');
	const rightInput = document.querySelector('.price-filter__to');
	leftInput.addEventListener('change', (e) => {
		const value = e.target.value;
		const rightValue = Number(slider.noUiSlider.get()[1]);
		if (Number(value) >= rightValue) {
			slider.noUiSlider.setHandle(0, 1000);
	...
	rightInput.addEventListener('change', (e) => {
		...
		if (value <= leftValue) {
			slider.noUiSlider.setHandle(1, leftValue);
			rightInput.value = leftValue;
		} else if (value > 1000) {
			slider.noUiSlider.setHandle(1, 1000);
			rightInput.value = 1000;
		} else {
	...
	slider.noUiSlider.on('change', () => {
		leftInput.value = Number(slider.noUiSlider.get()[0]);
		rightInput.value = Number(slider.noUiSlider.get()[1]);
	})
	leftInput.value = Number(slider.noUiSlider.get()[0]);
	rightInput.value = Number(slider.noUiSlider.get()[1]);
})();
